...
<body id="hpContatoSucessoPage" data-spy="scroll" data-target=".navbar" data-offset="60">
	...
	<section id="contato-sucesso" class="container-fluid servico-conteudo">
		<h2 class="titulo-secao text-center">SUCESSO</h2>
		<div class="container-fluid">
        
        <hr>
        
        <p style="text-align: center"><b>O e-mail foi enviado com sucesso. <a href="index.php">Voltar</a></b></p>
    </body>
</html>